...
data_folder = '/Volumes/yuan_lab/TIER2/tms-st_wenyi/cholangio/batch2/4_cell_class_segformerMacro/csv'; %annotations / cells
seg_folder = '/Volumes/yuan_lab/TIER2/tms-st_wenyi/cholangio/batch2/3_cell_seg/mat'; %1054 in RDS, 947 in proj5, not sure how many is overlapped
cws_folder = '/Volumes/yuan_lab/TIER2/tms-st_wenyi/cholangio/batch2/1_cws_tiling';
files = dir(fullfile(seg_folder, '*.tif'));

%%
save_folder = '/Volumes/yuan_lab/TIER2/tms-st_wenyi/cholangio/batch2/cellFeatures_v3_refine';
