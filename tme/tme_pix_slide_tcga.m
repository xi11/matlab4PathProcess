...
src_gp_mask = 'D:\DHMC\TMEseg\stroma_mask_ss1_final';
...
for i = 1:k
    ...
    wsi_ID = extractBefore(file_name, '.tif_post.png');
...
writetable(tableTmp, 'D:\DHMC\TMEseg\DHMC_LUAD143_TMEmatlab.xlsx')