...
src_path = '/Volumes/yuan_lab/TIER2/melanoma_vp/pilot1_Mar2025/pgmn_segformer_stainedgeV3_b2b/mask_ss1_x8';
...
tissue_labels = {'tumor', 'stroma', 'inflammatory', 'necrosis', ...
    ...
    'macrophage', 'alveoli', 'muscle', 'pigment'};
result_table = [];
...
writetable(T, fullfile(dst_path, 'TMEseg_TMEper_pgmnper.xlsx'));
