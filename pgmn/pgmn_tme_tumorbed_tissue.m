...
dst_path = '/Volumes/yuan_lab/TIER2/anthracosis/prospect_pilot10/ss1x8_pgmn_tme_tissue21_10000_tumorBed5tme_40000';
...
%         BW1 = imresize(BW1, [m, n], 'nearest');
        ...
        mask_tissue1(BW1) = tme1(BW1);
        mask_tissue2(BW1) = tme2(BW1);
        mask_tissue3(BW1) = tme3(BW1);
