...
dst_path1 = '/Volumes/yuan_lab/TIER2/anthracosis/never_smoker/pgmn_segformer_stainedgeV3/mask_ss1_x8_1filter0fill_dilate10_4tme';
dst_path2 = '/Volumes/yuan_lab/TIER2/anthracosis/never_smoker/pgmn_segformer_stainedgeV3/mask_ss1_x8_1filter0fill_dilate10_neighbour_4tme';
...
for i =1:length(files)
    ...
    if ~isfile(fullfile(dst_path1, [file_name, '_4tme.png']))
        ...
        radius = 10; %3pixel: 10.52um;10 pixel: 35.2um; 
