...
dst_path1 = '/Volumes/yuan_lab/TIER2/anthracosis/never_smoker/pgmn_segformer_stainedgeV3/mask_ss1_x8_dilate15_5_filter25_4tme';
dst_path2 = '/Volumes/yuan_lab/TIER2/anthracosis/never_smoker/pgmn_segformer_stainedgeV3/mask_ss1_x8_dilate15_5neighbour_filter25_4tme';
...
for i =1:length(files)
    ...
    if ~isfile(fullfile(dst_path1, [file_name, '_4tme.png']))
        ...
        pgmn_neigh3 = imdilate(pgmn_filtered, se1); % to eliminate noise
