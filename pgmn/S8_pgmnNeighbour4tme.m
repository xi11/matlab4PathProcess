...
dst_path1 = '/Volumes/yuan_lab/TIER2/anthracosis/cptac_luad/pgmn_segformer_stainedgeV3/mask_ss1_x8_1filter0fill_dilate17_4tme';
dst_path2 = '/Volumes/yuan_lab/TIER2/anthracosis/cptac_luad/pgmn_segformer_stainedgeV3/mask_ss1_x8_1filter0fill_dilate17_neighbour_4tme';
...
for i =1:length(files)
    ...
    if ~isfile(fullfile(dst_path1, [file_name, '_4tme.png']))
        ...
        radius = 17; %3pixel: 10.56um; 5px: 17.6um; 6px: 21.12um; 10 pixel: 35.2um; 11pix: 38.72um; 14px: 49.28um; 17pix: 59.84um; 23pix: 80.96um; 28pixel: 98.56um
