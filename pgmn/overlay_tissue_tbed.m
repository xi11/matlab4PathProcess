...
tbed_path = '/Volumes/yuan_lab/TIER2/anthracosis/visium_TMA5primary2014/tbed1536_ss1/maskLuadLusc_tmeMacro_tumor5per_remove10000';
pgmn_path = '/Volumes/yuan_lab/TIER2/anthracosis/visium_TMA5primary2014/pgmn_TMEsegDiv12sCE/mask_ss1_x8';
dst_path = '/Volumes/yuan_lab/TIER2/anthracosis/visium_TMA5primary2014/overlay_tissue_tbed_pigment_remove90000';
...
for i =1:length(files)
    ...
    disp(file_name)
        ...
        mask_tissue1 = tissue_color(1) *uint8(BW2);
        mask_tissue2 = tissue_color(2) *uint8(BW2);
        mask_tissue3 = tissue_color(3) *uint8(BW2);
        ...
        imwrite(mask_final, fullfile(dst_path, [file_name, '.svs_tissue_tbed_pgmn.png']))
