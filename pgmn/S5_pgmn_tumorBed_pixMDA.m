...
pgmn_mask = '/Volumes/yuan_lab/TIER2/anthracosis/nlst1225/pgmn_segformer_stainedgeV3/mask_ss1_x8';
tissue_mask = '/Volumes/yuan_lab/TIER2/anthracosis/nlst1225/ss1x8overlay_alveoli_tbedRefine_remove90000_nec'; %ss1x8overlay_alveoli_nonTper_tbedAlveoli81000tme_close5remove90000LN_nec';
dst_path = '/Volumes/yuan_lab/TIER2/anthracosis/nlst1225/pgmn_segformer_stainedgeV3/mask_ss1_x8_tbedmask';
...
for i = 1:k
    ...
    pgmn = logical(pgmn(:,:,2));
    tissue_raw = imread(fullfile(tissue_mask, [wsi_ID, '.svs_alveoli_tbed.png'])); %.svs_alveoli_tbed.png
    tissue = tissue_raw(:,:,2);
...
writetable(tableTmp, '/Volumes/yuan_lab/TIER2/anthracosis/nlst1225/pgmn_segformer_stainedgeV3/nlst_pgmn_tbedRefine_alveoli.xlsx')