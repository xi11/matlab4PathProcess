...
pgmn_neighbour = '/Volumes/yuan_lab/TIER2/anthracosis/never_smoker_multi/pgmn_segformer_stainedgeV3/mask_ss1_x8_1filter0fill_dilate5_4tme';
...
tbed_path = '/Volumes/yuan_lab/TIER2/anthracosis/never_smoker_multi/ss1x8overlay_alveoli_nonTper_tbedAlveoli81000tme_close5remove90000LN_nec';
dst_path1 = '/Volumes/yuan_lab/TIER2/anthracosis/never_smoker_multi/pgmn_segformer_stainedgeV3/mask_ss1_x8_1filter0fill_pgmn_tbed';
dst_path2 = '/Volumes/yuan_lab/TIER2/anthracosis/never_smoker_multi/pgmn_segformer_stainedgeV3/mask_ss1_x8_1filter0fill_pgmn_lung';
...
files = dir(fullfile(pgmn_neighbour, '*dilate1.png'));
for i =1:length(files)
    file_name = files(i).name(1:end-17); %_4tme_dilate1.png; -18: _neighbour4tme.png
    disp(file_name)
