...
pgmn_mask = '/Volumes/yuan_lab/TIER2/anthracosis/never_smoker_pilot10/pgmn_TMEsegDiv12sCE/mask_ss1_x8';
tissue_mask = '/Volumes/yuan_lab/TIER2/anthracosis/never_smoker_pilot10/ss1x8_tissue21_90000_tumorBed5_DCP20_90000';
files = dir(fullfile(pgmn_mask, '*.png'));

tableTmp = table("",0, 0, 0,0,'VariableNames',{'ID','pgmn_tbed', 'pgmn_norm', 'tumor_bed', 'tissue'});
k = length(files);
gp_pix = zeros(k, 4);
for i = 1:k
...
writetable(tableTmp, '/Users/xiaoxipan/Documents/project/anthracosis/pix_TMEsegFOplaindiv12sCE/NS_pilot10_pgmn_tumorBed.xlsx')