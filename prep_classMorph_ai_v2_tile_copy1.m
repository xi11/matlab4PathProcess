...
close all;
%%
data_folder = '/Volumes/yuan_lab/TIER2/st_lung/fullres/4_cell_class/csv'; %annotations / cells
...
%%
save_folder = '/Volumes/yuan_lab/TIER2/st_lung/fullres/cellFeatures_v1';
